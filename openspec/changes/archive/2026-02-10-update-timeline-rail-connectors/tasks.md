...
- [x] 1.3 Verify visually in light/dark glass themes with multi-line summaries and tag wraps; capture before/after screenshot if possible. (Not run; no UI validation.)
