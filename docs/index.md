...
This folder documents BetterMail's architecture, module boundaries, data flow, and refactor notes.
Use these pages as the canonical technical reference for onboarding and maintenance.
...
- [Mailbox Create-and-Move Debug Notes (Mar 2026)](mailbox-create-and-move-debug-notes.md)
