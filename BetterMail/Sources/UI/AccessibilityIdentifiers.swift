...
internal enum AccessibilityID {
    ...
    internal static let threadGeneratedTitle = "bettermail.thread-generated-title"
    internal static let threadGeneratedTitleRegenerateButton = "bettermail.thread-generated-title.regenerate"
    ...
    internal static let graphSnipCancelSession = "bettermail.graph-snip.cancel-session"
    internal static let graphSnipAllocationSheet = "bettermail.graph-snip.allocation-sheet"
    internal static let graphSnipBulkPicker = "bettermail.graph-snip.bulk-picker"
    internal static let graphSnipApplyAll = "bettermail.graph-snip.apply-all"
    internal static let graphSnipMoveBatch = "bettermail.graph-snip.move-batch"
    internal static let graphSnipDiscardSession = "bettermail.graph-snip.discard-session"
    internal static let graphThreadActions = "bettermail.graph-thread-actions"
    ...
    internal static let graphSuggestionReviewName = "bettermail.graph-suggestion-review.name"
    internal static let graphSuggestionReviewReason = "bettermail.graph-suggestion-review.reason"
    internal static let graphSuggestionReviewMembers = "bettermail.graph-suggestion-review.members"
    internal static let graphSuggestionReviewImpact = "bettermail.graph-suggestion-review.impact"
    internal static let graphSuggestionReviewCreate = "bettermail.graph-suggestion-review.create"
    internal static let graphSuggestionReviewNotThisGroup = "bettermail.graph-suggestion-review.not-this-group"
    internal static let graphSuggestionReviewHideTopic = "bettermail.graph-suggestion-review.hide-topic"
